...
const CAP = {
 ss: {
  en: ['Eight exercises for vision after stroke','Practise scanning into your lost side','Built around your condition','Watch your progress build','A one-tap report for your therapist','Sound, difficulty and colour — tuned to you','In 18 languages, including Welsh and Twi'],
  de: ['Acht Übungen für das Sehen nach dem Schlaganfall','Üben Sie das Blicken in Ihre betroffene Seite','Auf Ihre Diagnose zugeschnitten','Sehen Sie Ihren Fortschritt wachsen','Ein Therapeutenbericht mit einem Tipp','Ton, Schwierigkeit und Farben — ganz nach Ihnen','In 18 Sprachen, darunter Walisisch und Twi'],
  es: ['Ocho ejercicios para la visión tras un ictus','Practica escanear hacia tu lado perdido','Adaptado a tu condición','Mira crecer tu progreso','Informe para tu terapeuta con un toque','Sonido, dificultad y color — a tu medida','En 18 idiomas, incluidos galés y twi'],
  fr: ['Huit exercices pour la vision après un AVC','Entraînez le regard vers votre côté atteint','Conçu autour de votre condition','Regardez vos progrès grandir','Un rapport pour votre thérapeute en un geste','Son, difficulté et couleurs — réglés pour vous','En 18 langues, dont le gallois et le twi'],
  it: ["Otto esercizi per la vista dopo l'ictus",'Allena lo sguardo verso il lato perso','Costruito attorno alla tua condizione','Guarda crescere i tuoi progressi','Un report per il terapista con un tocco','Suono, difficoltà e colori — su misura per te','In 18 lingue, tra cui gallese e twi'],
  pt: ['Oito exercícios para a visão após o AVC','Treine o olhar para o seu lado perdido','Construído à volta da sua condição','Veja o seu progresso crescer','Relatório para o terapeuta com um toque','Som, dificuldade e cores — à sua medida','Em 18 línguas, incluindo galês e twi'],
  pt_br: ['Oito exercícios para a visão após o AVC','Treine o olhar para o seu lado perdido','Construído em torno da sua condição','Veja seu progresso crescer','Relatório para o terapeuta em um toque','Som, dificuldade e cores — do seu jeito','Em 18 idiomas, incluindo galês e twi'],
  pl: ['Osiem ćwiczeń wzroku po udarze','Ćwicz spoglądanie w utraconą stronę','Dopasowany do Twojego schorzenia','Patrz, jak rosną Twoje postępy','Raport dla terapeuty jednym dotknięciem','Dźwięk, trudność i kolory — pod Ciebie','W 18 językach, w tym walijskim i twi'],
  ja: ['脳卒中後の視覚のための8つのエクササイズ','見えない側へのスキャンを練習','あなたの症状に合わせて設計','積み重なる進歩を実感','ワンタップでセラピスト向けレポート','音・難易度・色をあなた好みに','ウェールズ語・トウィ語を含む18言語に対応'],
  ko: ['뇌졸중 후 시야를 위한 8가지 운동','보이지 않는 쪽으로 시선 옮기기 연습','내 증상에 맞춘 훈련','쌓여가는 진전을 확인하세요','원탭으로 치료사 리포트 생성','소리·난이도·색상을 내게 맞게','웨일스어와 트위어 포함 18개 언어'],
  hi: ['स्ट्रोक के बाद दृष्टि के लिए आठ अभ्यास','अपनी खोई हुई ओर देखने का अभ्यास करें','आपकी स्थिति के अनुसार बना','अपनी प्रगति बढ़ते देखें','एक टैप में थेरेपिस्ट के लिए रिपोर्ट','ध्वनि, कठिनाई और रंग — आपके अनुसार','वेल्श और त्वी सहित 18 भाषाओं में'],
  ar: ['ثمانية تمارين للبصر بعد السكتة الدماغية','تدرّب على المسح نحو جانبك المفقود','مصمّم حول حالتك','شاهد تقدّمك ينمو','تقرير لمعالجك بلمسة واحدة','الصوت والصعوبة والألوان — كما يناسبك','بـ 18 لغة، من بينها الويلزية والتوي'],
  zh: ['脑卒中后视觉训练的八项练习','练习向缺损一侧扫视','围绕你的症状而设计','看着进步一点点累积','一键生成治疗师报告','声音、难度与颜色——由你调节','支持18种语言，包括威尔士语和特威语'],
 },
 rw: {
  en: ['Relearn handwriting, one stroke at a time','From letters to words to full sentences',"BIG Practice for Parkinson's micrographia",'Feedback that encourages, never a cold score','Practise the words that matter to you','A one-tap report for your therapist','18 languages, each with true stroke order'],
  de: ['Schreiben neu lernen — Strich für Strich','Von Buchstaben zu Wörtern zu ganzen Sätzen','GROSS-Übungen für die Parkinson-Mikrographie','Feedback, das ermutigt — nie eine kalte Note','Üben Sie die Wörter, die Ihnen wichtig sind','Ein Therapeutenbericht mit einem Tipp','18 Sprachen, jede mit echter Strichfolge'],
  es: ['Reaprende a escribir, trazo a trazo','De letras a palabras y frases completas','Práctica GRANDE para la micrografía del Parkinson','Comentarios que animan, nunca una nota fría','Practica las palabras que te importan','Informe para tu terapeuta con un toque','18 idiomas, cada uno con su orden de trazos'],
  fr: ["Réapprenez l'écriture, trait après trait",'Des lettres aux mots, puis aux phrases','Pratique GRAND pour la micrographie de Parkinson','Des retours qui encouragent, jamais de note froide','Entraînez les mots qui comptent pour vous','Un rapport pour votre thérapeute en un geste','18 langues, chacune avec son ordre des tracés'],
  it: ['Reimpara a scrivere, un tratto alla volta','Dalle lettere alle parole alle frasi','Pratica GRANDE per la micrografia del Parkinson','Feedback che incoraggia, mai un voto freddo','Esercita le parole che contano per te','Un report per il terapista con un tocco','18 lingue, ognuna con il giusto ordine dei tratti'],
  pt: ['Reaprenda a escrever, traço a traço','De letras a palavras a frases completas','Prática GRANDE para a micrografia de Parkinson','Feedback que encoraja, nunca uma nota fria','Pratique as palavras que importam para si','Relatório para o terapeuta com um toque','18 línguas, cada uma com a ordem certa dos traços'],
  pt_br: ['Reaprenda a escrever, traço a traço','De letras a palavras a frases completas','Prática GRANDE para a micrografia de Parkinson','Feedback que encoraja, nunca uma nota fria','Pratique as palavras que importam para você','Relatório para o terapeuta em um toque','18 idiomas, cada um com a ordem certa dos traços'],
  pl: ['Naucz się pisać na nowo, kreska po kresce','Od liter przez słowa po całe zdania','DUŻE pisanie przy mikrografii w Parkinsonie','Feedback, który zachęca — nigdy zimna ocena','Ćwicz słowa, które są dla Ciebie ważne','Raport dla terapeuty jednym dotknięciem','18 języków, każdy z prawdziwą kolejnością kresek'],
  ja: ['一画ずつ、書くことをもう一度','文字から単語、そして文へ','小字症のための「大きく書く練習」','冷たい点数ではなく、励ますフィードバック','あなたにとって大切な言葉を練習','ワンタップでセラピスト向けレポート','18言語、それぞれ正しい書き順で'],
  ko: ['한 획씩, 다시 배우는 손글씨','글자에서 단어, 그리고 문장으로','소자증을 위한 크게 쓰기 연습','차가운 점수가 아닌, 격려하는 피드백','나에게 소중한 단어를 연습하세요','원탭으로 치료사 리포트 생성','18개 언어, 저마다 정확한 획순으로'],
  hi: ['एक-एक स्ट्रोक से लिखना फिर सीखें','अक्षरों से शब्द, फिर पूरे वाक्य','पार्किंसन माइक्रोग्राफिया के लिए BIG अभ्यास','उत्साह बढ़ाने वाला फ़ीडबैक, ठंडा स्कोर नहीं','वे शब्द लिखें जो आपके लिए मायने रखते हैं','एक टैप में थेरेपिस्ट के लिए रिपोर्ट','18 भाषाएँ, हर एक सही स्ट्रोक-क्रम के साथ'],
  ar: ['تعلّم الكتابة من جديد، حركة بحركة','من الحروف إلى الكلمات إلى جمل كاملة','تمرين الكتابة الكبيرة لصِغَر الخط في باركنسون','ملاحظات تشجّع — لا درجات باردة','تدرّب على الكلمات المهمة لك','تقرير لمعالجك بلمسة واحدة','18 لغة، لكلٍّ منها ترتيب حركاتها الصحيح'],
  zh: ['一笔一画，重新学会书写','从字母到词语，再到完整句子','针对帕金森写字过小的大字练习','鼓励式反馈，而非冰冷的分数','练习对你重要的词语','一键生成治疗师报告','18种语言，每种都有正确笔顺'],
 },
};
